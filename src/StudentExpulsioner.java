...
public class StudentExpulsioner {
    ...
    public static void main(String[] args) {
        ...
        boolean robot = args[0].toLowerCase().contains("robot");
        boolean sppo = args[1].toLowerCase().contains("sppo");
        boolean ivt = args[2].toLowerCase().contains("ivt");
        boolean random = args[3].toLowerCase().contains("random");
        boolean fullMoon = args[4].toLowerCase().contains("full");
        ...
        System.out.println(StrategyChainBuilder.build(student3, strategyBulider3));
